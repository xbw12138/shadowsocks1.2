...
import com.xbw.shadowsocks.core.LocalVpnService;
import com.xbw.shadowsocks.core.ProxyConfig;
            ...
            case R.id.menu_item_about:
                new AlertDialog.Builder(this)
                        ...
                        .setNegativeButton(R.string.btn_more, new OnClickListener() {
                            @Override
                            public void onClick(DialogInterface dialog, int which) {
                                startActivity(new Intent(Intent.ACTION_VIEW, Uri.parse("http://weibo.com/u/5368201773")));
                            }
                        })
                        .show();
